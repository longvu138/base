...
export type CreateShipmentUiStyle = "style1" | "style2" | "style3";
...
export const CreateShipmentView = ({ uiStyle = "style1", logic }: CreateShipmentViewProps) => {
  ...
  const isStyle3 = uiStyle === "style3";
  const cardStyle = isStyle2
    ? { borderRadius: 4, borderColor: "#d9d9d9" }
    : isStyle3
      ? { borderRadius: 0, boxShadow: "none" }
      : undefined;
  const pageSpaceSize = isStyle3 ? 12 : 16;
...
export const CreateShipmentStyle1 = () => {
  const logic = useCreateShipmentPage();

  return <CreateShipmentView uiStyle="style1" logic={logic} />;
};

export const CreateShipment = CreateShipmentStyle1;

export default CreateShipmentStyle1;
