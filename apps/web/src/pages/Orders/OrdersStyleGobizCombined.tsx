...
import { OrdersStyleGobiz } from './OrdersStyleGobiz';
 ...
 */
export const OrdersStyleGobizCombined: React.FC<{ defaultTab?: string }> = ({ defaultTab = 'orders' }) => {
    ...
    const items = [
        {
            ...
            children: <OrdersStyleGobiz isTabView={true} />,
        },
        {
            key: 'shipments',
            label: (
