...
export const RegisterStyleThanhla = ({ form, onFinish, isLoading, projectInfo }: any) => {
    ...
    return (
        <div className="mobile-page-container p-5">
            {bgImage ? (
                <div className="mb-6 -mx-5 -mt-5 h-48 overflow-hidden rounded-b-[2rem]">
...
export default RegisterStyleThanhla;
